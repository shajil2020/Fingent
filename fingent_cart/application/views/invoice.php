								...
								<form method="post" action="<?php echo base_url() ?>cart/save_order_details">
											...
											<div class="table-responsive">
												<table class="table">
													...
													<tr>
														...
														<td>
															<span id="old_total_with_tax">
																<?php echo ($tax_rate + $sub_total); ?></span>
									...
									<div class="row no-print">
										<div class="col-12">
											...
											<a href="<?php echo base_url() ?>cart" rel="noopener" class="btn btn-success"><i class="fas fa-cart"></i> Continue Purchase
											</a>
